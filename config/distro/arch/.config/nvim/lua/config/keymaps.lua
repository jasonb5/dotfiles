...
keymap.set("n", "<leader>tr", "<cmd>TaskRecent<cr>", { silent = true, desc = "Recent task days" })
keymap.set("n", "<leader>ta", "<cmd>TaskAdd<cr>", { silent = true, desc = "Add task" })
keymap.set("n", "<leader>tg", "<cmd>TaskRegenerateToday<cr>", { silent = true, desc = "Regenerate today's tasks" })
